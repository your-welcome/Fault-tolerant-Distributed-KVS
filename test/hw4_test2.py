...
##########################################################################
    ...
    def test_j_key_redistributed(self):
        ...
        key = 'key1'
        self.confirmAddKey(targetNode, key, 'value1', 201, "Added successfully", False, {})
        ...
        self.confirmGetKey(targetNode, 'key1', 200, "Success", 'value1', str(hash(key)%2))

        self.confirmGetKey(ipPort, 'key1', 200, "Success", 'value1', str(hash(key)%2))
